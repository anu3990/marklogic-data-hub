...
import { Code, ExternalLinkAlt, RightOutlined } from '@marklogic/design-system/es/MLIcon';
            ...
            <div className={styles.title} onClick={() => showTableEntityProperties()}>
                ...
                <div className={styles.redirectIcons}>
                    <Link to={{pathname: `/tiles/explore/detail/${detailPath}/${uri}`,state: {selectedValue:'instance',
                        ...
                        <MLTooltip title={'Show the processed data'}><ExternalLinkAlt data-testid='instance-icon' /></MLTooltip>
                    </Link>
                    <Link to={{pathname: `/tiles/explore/detail/${detailPath}/${uri}`,state: {selectedValue:'source',
                        ...
                        <MLTooltip title={'Show the complete ' + fileTypeVal.toUpperCase()}><Code  data-testid='source-icon' /></MLTooltip>
                    </Link>
                </div>
