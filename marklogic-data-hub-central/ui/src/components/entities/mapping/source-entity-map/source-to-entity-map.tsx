...
import { List, QuestionCircleFilled, DownOutlined, LeftOutlined, RightOutlined, CloseOutlined, CheckOutlined, PencilAlt, SearchOutlined, Search, ObjectUngroup } from '@marklogic/design-system/es/MLIcon';
...
const SourceToEntityMap = (props) => {
    ...
    const srcDetails = props.mapData && props.mapData.sourceQuery && props.mapData.selectedSource ? <div className={styles.xpathDoc}>
        ...
        {!editingURI ? <div
            ...
            <span className={styles.showingEditContainer}>URI: <span className={styles.showingEditIcon}>{getLastChars(srcURI,42,'...')}  <i><PencilAlt className={styles.editIcon} onClick={handleEditIconClick} 
    ...
    const getColumnFilterProps = dataIndex => ({
        ...
        filterIcon: filtered => <i><Search data-testid={`filterIcon-${dataIndex}`} className={ filtered ? 'active' : 'inactive' } /></i>,
            ...
            render: (text, row) => (<div className={styles.mapExpParentContainer}><div className={styles.mapExpressionContainer}>
                ...
                <span>
                    <Dropdown overlay={sourceSearchMenu} trigger={['click']} disabled={!props.canReadWrite}>
                        <i  id="listIcon" data-testid={row.name.split('/').pop()+'-listIcon1'}><List data-testid={row.name.split('/').pop()+'-listIcon'} className={styles.listIcon} onClick={(e) => handleSourceList(row)}/></i>
                    </Dropdown>
                </span>
                &nbsp;&nbsp;
                ...
                >
                    <div
                        ...
                        <div id="srcDetails" data-testid="srcDetails" className={styles.sourceDetails}>
                            ...
                            ><i><List className={styles.sourceDataIcon}
                    ...
                    <div
                        ...
                        <div className={styles.entityDetails}>
                            <span className={styles.entityTypeTitle}><p ><i><ObjectUngroup className={styles.entityIcon} /></i> Entity: {props.entityTypeTitle}</p></span>
                        </div>
