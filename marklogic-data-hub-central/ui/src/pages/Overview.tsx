...
import { LongArrowAltRight, Cube, Cubes, ObjectUngroup, ProjectDiagram } from '@marklogic/design-system/es/MLIcon';
                ...
                <div className={styles.cards}>
                    <div className={styles.cardLoad}>
                        ...
                        <div className={styles.subtitle}>
                            <i aria-label="load-icon"><LongArrowAltRight /></i>Load
                        </div>
                    ...
                    <div className={styles.cardModel}>
                        ...
                        <div className={styles.subtitle}>
                            <i aria-label="model-icon"><Cube /></i>Model
                        </div>
                    ...
                    <div className={styles.cardCurate}>
                        ...
                        <span className={styles.icon}></span> 
                        <div className={styles.subtitle}>
                            <i aria-label="curate-icon"><ObjectUngroup /></i>Curate
                        </div>
                    ...
                    <div className={styles.cardRun}>
                        <div className={styles.head}>
                            <span className={styles.icon}></span> 
                            <div className={styles.subtitle}>
                                <i aria-label="run-icon"><Cubes /></i>Run
                            </div>
